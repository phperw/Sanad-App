...
import '../../features/account/ui/Widgets/leaderboard/data/api service/leaderboard_api_service.dart';
import '../../features/account/ui/Widgets/leaderboard/data/repo/all_time_repo/all_time_leaderboard_repository.dart';
import '../../features/account/ui/Widgets/leaderboard/data/repo/monthly_repo/monthly_leaderboard_repository.dart';
import '../../features/account/ui/Widgets/leaderboard/data/repo/weekly_repo/weekly_leaderboard_repository.dart';
import '../../features/account/ui/Widgets/leaderboard/logic/Weekly_cubit/weekly_leaderboard_cubit.dart';
import '../../features/account/ui/Widgets/leaderboard/logic/all_time_cubit/all_time_leaderboard_cubit.dart';
import '../../features/account/ui/Widgets/leaderboard/logic/monthly_cubit/monthly_leaderboard_cubit.dart';
...
import '../../features/chats_and_community/data/api_service/chat_bot_service.dart';
...
Future<void> setupDependencies() async {
  ...
  // Leaderboard
  getIt.registerLazySingleton(() => LeaderboardApiService(getIt()));
  getIt.registerLazySingleton(() => WeeklyLeaderboardRepository(getIt()));
  getIt.registerLazySingleton(() => MonthlyLeaderboardRepository(getIt()));
  getIt.registerLazySingleton(() => AllTimeLeaderboardRepository(getIt()));
  getIt.registerFactory(() => WeeklyLeaderboardCubit(getIt()));
  getIt.registerFactory(() => MonthlyLeaderboardCubit(getIt()));
  getIt.registerFactory(() => AllTimeLeaderboardCubit(getIt()));
