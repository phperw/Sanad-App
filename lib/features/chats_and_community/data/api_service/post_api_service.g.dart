...
class _PostApiService implements PostApiService {
  ...
  @override
  Future<CommunityFeedResponse> getCommunityFeed(int page, int limit) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{r'page': page, r'limit': limit};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<CommunityFeedResponse>(
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late CommunityFeedResponse _value;
    try {
      _value = CommunityFeedResponse.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options, response: _result);
      rethrow;
    }
