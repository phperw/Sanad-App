...
class AllTimeLeaderboardView extends StatefulWidget {
  const AllTimeLeaderboardView({super.key});

  @override
  State<AllTimeLeaderboardView> createState() => _AllTimeLeaderboardViewState();
}

class _AllTimeLeaderboardViewState extends State<AllTimeLeaderboardView> {
  bool isLoading = true;
  ...
  Future<void> _fetchAllTimeData() async {
