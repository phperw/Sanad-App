...
import '../../logic/all_time_cubit/all_time_leaderboard_cubit.dart';
import '../../logic/leaderboard_state.dart';

class AllTimeLeaderboardView extends StatelessWidget {
  const AllTimeLeaderboardView({super.key});

  @override
  Widget build(BuildContext context) {
    return BlocProvider(
      create: (_) => getIt<AllTimeLeaderboardCubit>()..getAllTimeLeaderboard(),
      child: const _AllTimeLeaderboardContent(),
    );
  }
}

class _AllTimeLeaderboardContent extends StatelessWidget {
  const _AllTimeLeaderboardContent();

  @override
  Widget build(BuildContext context) {
    return BlocBuilder<AllTimeLeaderboardCubit, LeaderboardState>(
              ...
              child: Column(
                children: [
                  ...
                  _CurrentUserCard(
                    ...
                    subtitle: '${data.currentUser.points} نقطة منذ الانضمام',
                  ),
                ],
              ),
            ),
